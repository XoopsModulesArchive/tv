...
function entete()
{
    echo '' . '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">' . '<HTML>' . '<HEAD>' . '<TITLE>Upgrade module TV pour XOOPS RC2</TITLE>' . '</HEAD>' . '<BODY>' . '<CENTER><H1>Upgrade du module TV 1.9 vers 1.94</H1></CENTER><br><br>';
}
...
function license()
{
    ...
    echo '' . '<form action=upgrade194.php method="post">' . '<center>';
...
function AlterTable()
{
    ...
    echo '<form action=upgrade194.php method="post">' . '<center>' . 'Champ <i>player</i> ajouté!!!<br>' . '<table width="50%" align=center>'; ?>
    <tr>
        <td align=center>
